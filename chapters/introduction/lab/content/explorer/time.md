...
Check Ethereum [Explorer](https://etherscan.io/) and Solana [Explorer](https://solscan.io) and see how (almost) at every 12, respectively 1 seconds a new block appears.
