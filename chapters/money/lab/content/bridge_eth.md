...
![Superbridge Activate Testnet](../media/superbridge_activate_testnets.png)
...
![Superbridge Metamask Confirmation](../media/superbridge_metamask_conf.png)

In the bridging interface, choose to move funds from Ethereum Sepolia to Base Sepolia.

![Superbridge Choose Base Sepolia](../media/superbridge_base_sepolia.png)

Input the amount of tokens you want to transfer. Now, we will move 0.007 ETH.

![Superbridge Amount](../media/superbridge_bridges.png)
...
![Superbridge Review](../media/superbridge_review.png)
...
![Superbridge Confirm](../media/superbridge_confirm.png)
